########################################################################
# title         : 03_season_differential_cooccur_network.R
# purpose       : find the differences of network model in different seasons
...
# df_wet is the dataframe selected in wet season
...
# call function from 01_co_occurrence_injury_pairwise.R
  ...
  # compare correlation coefficient of each pair of injuries of condition A and 
  # condition B
  
  # call diff.corr function from 02_co_network_creation.R #
  ...
  ###### create the differential network in seasons #####
