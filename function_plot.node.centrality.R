########################################################################
# title         : function_plot.node.centrality.R
# purpose       : plot node properties (node degree, clustering coefficient, 
#               : betweenness)
# producer      : prepared by S. Jaisong (s.jaisong@irri.org);
# last update   : in Los Baños, Laguna, PHL, Jun 2016;
# inputs        : output as the dataframe from 02_co_network_creation.R 
# outputs       : dotgraph (ggplot object) showing node centrality 
# remarks 1     : 
######################################################################
